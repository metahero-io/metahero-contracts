...
describe('MetaheroLPMForUniswapV2', () => {
  ...
  before(async () => {
    ...
    const factory = await deployContract(owner, PancakeFactoryArtifact, [
      owner.address,
    ]);
    ...
    uniswapRouter = (await deployContract(owner, PancakeRouterArtifact, [
      factory.address,
      wrappedNative.address,
    ])) as IUniswapV2Router02;

    stableCoin = (await deployContract(owner, ERC20MockArtifact)) as ERC20Mock;
